            ...
            <div class="row card">
                <div class="col card-body">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                <label for="identificacao_do_equipamento" class="form-label">Identificacao do Equipamento/Cod Equipamento:</label>
                 ...
                 <div class="col-4">
                        <div class="form-group">
                            ...
                            <select name="necessario_correcao_imediata" id="necessario_correcao_imediata" class="form-control selecao">
                                ...
                                @foreach ($necessario_correcao_imediata as $key => $t)
                                    <option value="{{ $t }}" @if(isset($registro_de_ocorrencia) && $registro_de_ocorrencia->necessario_correcao_imediata == $t)  selected @elseif(old('necessario_correcao_imediata') == $t) selected @endif >{{$t}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="descrever_correcao" id="descrever_correcao" rows="3" required> @if(isset($novo_rnc)){{$novo_rnc->descrever_correcao}}@else{{ old('descrever_correcao')}}@endif</textarea>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="parecer_tecnico" id="parecer_tecnico" rows="3" required> @if(isset($novo_rnc)){{$novo_rnc->parecer_tecnico}}@else{{ old('parecer_tecnico')}}@endif</textarea>
                        </div>
